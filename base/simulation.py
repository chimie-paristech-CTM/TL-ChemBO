"""Unwrap the simulate_scenarios() and record the evolution of lengthscales.

A copy for "from baybe.simulation import simulate_scenarios" 
as well as for "from baybe.simulation.core import simulate_experiment":"""
...
from base.simul_core import simulate_experiment_in_house
...
def simulate_scenarios_in_house(
...
def _simulate_groupby(
    ...
    *,
    ...
    for group_id, group in groups:
        ...
        try:
            df_group = simulate_experiment_in_house(
                campaign_group,
                lookup,
                batch_size=batch_size,
                n_doe_iterations=n_doe_iterations,
